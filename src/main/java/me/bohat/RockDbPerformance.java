...
import static me.bohat.TableForLookup.*;
public class RockDbPerformance {
    private static final String dbPath   = "D:\\File\\rocksdb-data\\";
    private static final String cfdbPath = "D:\\File\\rocksdb-data-cf\\";
    static {
        RocksDB.loadLibrary();
    }
    public static void main(String[] args) throws Exception {
        Stopwatch timer = Stopwatch.createStarted();
        long numberOfData = 1000000;
        createTable(cfdbPath);
//        assignValue(cfHandle,rocksDB,numberOfData);
        testGetData(cfHandle,rocksDB,numberOfData);
        System.out.println("Message: " + numberOfData);
